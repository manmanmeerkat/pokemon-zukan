...
export const WesternFukusai: React.FC<WesternProps> = memo(() => {
  ...
  const { searchedDishes, handleIngredientSearch } = useIngredientSearch("western-fukusai", user?.id);
